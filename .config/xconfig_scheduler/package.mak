...
override PKGDIR = xconfig_scheduler
...
/opt/ti/bios_6_40_01_15/packages/ti/targets/C28_large.xs:
package.mak: /opt/ti/bios_6_40_01_15/packages/ti/targets/C28_large.xs
/opt/ti/bios_6_40_01_15/packages/ti/targets/C28_float.xs:
package.mak: /opt/ti/bios_6_40_01_15/packages/ti/targets/C28_float.xs
/opt/ti/bios_6_40_01_15/packages/ti/targets/package.xs:
package.mak: /opt/ti/bios_6_40_01_15/packages/ti/targets/package.xs
/opt/ti/bios_6_40_01_15/packages/ti/targets/elf/ITarget.xs:
package.mak: /opt/ti/bios_6_40_01_15/packages/ti/targets/elf/ITarget.xs
...
ti.targets.elf.packageBase ?= /opt/ti/bios_6_40_01_15/packages/ti/targets/elf/
...
package/%.xdc.inc package/%_xconfig_scheduler.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_scheduler" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e66 .dlls: scheduler.pe66

-include package/cfg/scheduler_pe66.mak
-include package/cfg/scheduler_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/scheduler_pe66.dep
endif
scheduler.pe66: package/cfg/scheduler_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
scheduler.pe66 package/cfg/scheduler_pe66.c: .libraries,e66
endif

package/cfg/scheduler_pe66.c package/cfg/scheduler_pe66.h package/cfg/scheduler_pe66.xdl: override _PROG_NAME := scheduler.xe66
package/cfg/scheduler_pe66.c: package/cfg/scheduler_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/scheduler_pe66.cfg
	-$(RM) package/cfg/scheduler_pe66.dep
	-$(RM) package/cfg/scheduler_pe66.c
	-$(RM) package/cfg/scheduler_pe66.xdc.inc

clean,e66::
	-$(RM) scheduler.pe66
.executables,e66 .executables: scheduler.xe66

scheduler.xe66: |scheduler.pe66

-include package/cfg/scheduler.xe66.mak
scheduler.xe66: package/cfg/scheduler_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/scheduler_pe66.oe66   package/cfg/scheduler_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/libc.a
	
scheduler.xe66: export C_DIR=
scheduler.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

scheduler.test test,e66 test: scheduler.xe66.test

scheduler.xe66.test:: scheduler.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 scheduler.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.scheduler.xe66, ) 
endif
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
scheduler_pe66.oe66,copy : package/cfg/scheduler_pe66.oe66
scheduler_pe66.se66,copy : package/cfg/scheduler_pe66.se66

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_scheduler
xconfig_scheduler.tar: package/package.bld.xml
xconfig_scheduler.tar: package/build.cfg
xconfig_scheduler.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_scheduler.tar.dep
endif
package/rel/xconfig_scheduler/xconfig_scheduler/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_scheduler.tar: package/rel/xconfig_scheduler.xdc.inc package/rel/xconfig_scheduler/xconfig_scheduler/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_scheduler.xdc.inc,package/rel/xconfig_scheduler.tar.dep)


release release,xconfig_scheduler: all xconfig_scheduler.tar
clean:: .clean
	-$(RM) xconfig_scheduler.tar
	-$(RM) package/rel/xconfig_scheduler.xdc.inc
